# -*- coding: utf-8 -*-
"""
Created on Tue Aug 25 12:27:36 2020
...
#Used for dataframes
import pandas as pd
#Email notifications and accebility on Google Cloud
import smtplib
from email.mime.multipart import MIMEMultipart
from email.mime.text import MIMEText

#Pairs Trading Algorithm - I've only lost money with it
def pairs_trading_algo(self):
    
    #Specify paper trading environment 
    os.environ["APCA_API_BASE_URL"] = "https://paper-api.alpaca.markets"
    #Insert API Credentials 
    api = tradeapi.REST('PKITPGVJDWW86PGFLGBI', 'UMg7WBAYGdJFH7KneUoGgBCEVxwLxcIcEhQqWGzj', api_version='v2') # or use ENV Vars shown below
    account = api.get_account()
    
    #The mail addresses and password
    sender_address = 'tradebot2020tradebot'
    sender_pass = 'DoctorMario1997'
    receiver_address = 'isaiahs335@gmail.com'
    #Setup the MIME
    ...
    #Selection of stocks - You can always change the stock no problem
    days = 1000
    stock1 = 'AAPL'
    stock2 = 'AMD'
